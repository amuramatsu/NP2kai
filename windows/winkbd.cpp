...
static UINT8 key101[256] = {
			...
			//	  Ｐ,  Ｑ,  Ｒ,  Ｓ,  Ｔ,  Ｕ,  Ｖ,  Ｗ		; 0x50
				0x19,0x10,0x13,0x1e,0x14,0x16,0x2c,0x11,
			//	  Ｘ,  Ｙ,  Ｚ,LWIN,RWIN, APP,    ,    		; 0x58
				0x2a,0x15,0x29,0x51,0x35,0x72,  NC,  NC,
			//	<０>,<１>,<２>,<３>,<４>,<５>,<６>,<７>		; 0x60
				0x4e,0x4a,0x4b,0x4c,0x46,0x47,0x48,0x42,
			//	<８>,<９>,<＊>,<＋>,<，>,<−>,<．>,<／>		; 0x68
				0x43,0x44,0x45,0x49,0x4f,0x40,0x50,0x41,
			...
			//	    ,    ,    ,    ,    ,    ,    ,    		; 0x88
				  NC,  NC,  NC,  NC,  NC,  NC,  NC,  NC,
			//	HELP, ALT,<＝>,    ,    ,    ,    ,    		; 0x90
				  NC,0x71,0x4d,  NC,  NC,  NC,  NC,  NC,
			//	    ,    ,    ,    ,    ,    ,    ,    		; 0x98
				  NC,  NC,  NC,  NC,  NC,  NC,  NC,  NC,
			//	SFTL,SFTR,CTLL,CTLR,ALTL,ALTR,    ,    		; 0xa0
				0x70,0x33,0x74,0x71,0x73,0x72,  NC,  NC,
			//	    ,    ,    ,    ,    ,    ,    ,    		; 0xa8
				  NC,  NC,  NC,  NC,  NC,  NC,  NC,  NC,
			//	    ,    ,    ,    ,    ,    ,    ,    		; 0xb0
				  NC,  NC,  NC,  NC,  NC,  NC,  NC,  NC,
			//	    ,    ,  ;:,  =+,  ，,   −,  ．,  ／		; 0xb8
				  NC,  NC,0x26,0x0C,0x30,0x0b,0x31,0x32,
			//	  `~,    ,    ,    ,    ,    ,    ,    		; 0xc0
				0x0d,  NC,  NC,  NC,  NC,  NC,  NC,  NC,
			//	    ,    ,    ,    ,    ,    ,    ,    		; 0xc8
				  NC,  NC,  NC,  NC,  NC,  NC,  NC,  NC,
			//	    ,    ,    ,    ,    ,    ,    ,    		; 0xd0
				  NC,  NC,  NC,  NC,  NC,  NC,  NC,  NC,
			//	    ,    ,    ,  ［,  \|,  ］,  '",  ＿		; 0xd8
				  NC,  NC,  NC,0x1a,0x28,0x1b,0x27,0x33,
			//	    ,    ,  ＿,    ,    ,    ,    ,    		; 0xe0
				  NC,  NC,0x33,  NC,  NC,  NC,  NC,  NC,
			//	    ,    ,    ,    ,    ,    ,    ,    		; 0xe8
				  NC,  NC,  NC,  NC,  NC,  NC,  NC,  NC,
...
static const UINT8 key101ext[256] = {
			//	    ,    ,    ,STOP,    ,    ,    ,    		; 0x00
				  NC,  NC,  NC,  NC,  NC,  NC,  NC,  NC,
			//	  BS, TAB,    ,    , CLR, ENT,    ,    		; 0x08
				  NC,  NC,  NC,  NC,  NC,  NC,  NC,  NC,
...
void winkbd_keydown(WPARAM wParam, LPARAM lParam) {
	...
	if (np2oscfg.KEYBOARD == KEY_KEY101) {
		data = key101[wParam & 0xff];
		if (data != NC) {
			if ((!(lParam & 0x01000000)) &&
				(key101ext[wParam & 0xff] != NC) &&
				(!np2oscfg.USENUMLOCK)) {			// ver0.28
				keystat_senddata(0x70);							// PC/AT only!
				data = key101ext[wParam & 0xff];
			}
			if (data == 0x79)
			{
				// APPキー特例
